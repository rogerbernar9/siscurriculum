...
// Returns the private 'App\Repository\CandidaturaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CandidaturaRepository.php';

return $this->privates['App\Repository\CandidaturaRepository'] = new \App\Repository\CandidaturaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
