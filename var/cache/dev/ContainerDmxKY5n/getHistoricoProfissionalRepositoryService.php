...
// Returns the private 'App\Repository\HistoricoProfissionalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HistoricoProfissionalRepository.php';

return $this->privates['App\Repository\HistoricoProfissionalRepository'] = new \App\Repository\HistoricoProfissionalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
