...
// Returns the private 'App\Repository\CargoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CargoRepository.php';

return $this->privates['App\Repository\CargoRepository'] = new \App\Repository\CargoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
