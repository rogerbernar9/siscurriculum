...
// Returns the private 'App\Repository\TecnologiaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TecnologiaRepository.php';

return $this->privates['App\Repository\TecnologiaRepository'] = new \App\Repository\TecnologiaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
