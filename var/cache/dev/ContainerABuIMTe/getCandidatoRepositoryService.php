...
// Returns the private 'App\Repository\CandidatoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CandidatoRepository.php';

return $this->privates['App\Repository\CandidatoRepository'] = new \App\Repository\CandidatoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
